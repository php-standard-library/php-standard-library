...
See [src/Psl/RandomSequence/](https://github.com/php-standard-library/php-standard-library/tree/6.3.0/packages/random-sequence/src/Psl/RandomSequence/) for the full API.
